...
export default function CalculoIva() {
  ...
  if (tipo === "neto") {
    neto = numMonto;
    iva = Math.round(numMonto * ivaRate);
    bruto = neto + iva;
  } else {
    bruto = numMonto;
    neto = Math.round(numMonto / (1 + ivaRate));
    iva = bruto - neto;
  }
      ...
      <div className="site-container max-w-4xl space-y-10 sm:space-y-12">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-sm md:text-base max-w-xl">
            Calcula el IVA (19%) en Chile de forma simple, obteniendo el valor neto, el impuesto y el monto total para tus compras o ventas.
          </p>
        </div>
