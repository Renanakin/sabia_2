...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  forbidden: 'Esta cuenta no está asociada a este portal.',
  not_authenticated: 'Tu sesión expiró. Vuelve a iniciar sesión.',
};

export default function LoginForm({ slug, initialError }: Props) {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    if (res.data?.user.role !== 'cliente') {
      ...
      setError('Esta cuenta no corresponde a un cliente.');
      setLoading(false);
      return;
    }
